...
const translations: Record<Language, Record<string, string>> = {
  vi: {
    ...
    'contact.form_email': 'Địa chỉ Email (nếu có)',
    'contact.form_message': 'Nội dung tin nhắn / Yêu cầu đặt phòng...',
    'contact.form_msg': 'Nội dung tin nhắn / Yêu cầu đặt phòng...',
    'contact.form_send': 'Gửi yêu cầu ngay',
    'contact.form_submit': 'Gửi Yêu Cầu Tư Vấn Ngay',
    'contact.form_success': 'Gửi Yêu Cầu Thành Công!',
    'contact.form_success_msg': 'Lễ tân Galaxy Boutique Hotel đã nhận được thông tin và sẽ gọi lại cho bạn sớm nhất!',
    'contact.date_in': 'Dự kiến nhận phòng',
    'contact.date_out': 'Dự kiến trả phòng',
    'contact.room_select': 'Loại phòng quan tâm',
    'contact.guests_count': 'Số lượng khách',
    'calendar.today': 'Hôm nay',
    'calendar.available': 'Còn phòng',
    'calendar.locked': 'Đã khóa phòng',
    'calendar.full': 'Hết phòng',
    'calendar.rooms_left': 'phòng trống',
  ...
  en: {
    ...
    'contact.form_email': 'Email Address (optional)',
    'contact.form_message': 'Your Message / Booking Request...',
    'contact.form_msg': 'Your Message / Booking Request...',
    'contact.form_send': 'Send Inquiry Now',
    'contact.form_submit': 'Submit Consultation Request',
    'contact.form_success': 'Request Submitted Successfully!',
    'contact.form_success_msg': 'Galaxy Boutique Hotel front desk has received your request and will contact you shortly!',
    'contact.date_in': 'Expected Check-in',
    'contact.date_out': 'Expected Check-out',
    'contact.room_select': 'Preferred Room Type',
    'contact.guests_count': 'Number of Guests',
    'calendar.today': 'Today',
    'calendar.available': 'Available',
    'calendar.locked': 'Room Locked',
    'calendar.full': 'Fully Booked',
    'calendar.rooms_left': 'rooms left',
