...
$db_host = 'localhost';
$db_name = 'rnaacriz_galaxy';     // Tên database chính xác trên hosting cPanel AZDIGI
$db_user = 'rnaacriz_galaxy';     // Tên user database cPanel
...
// Thử kết nối với các biến thể cấu hình cPanel
$credentialsToTry = [
